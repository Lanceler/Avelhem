...
export const useDemoGameStates = () => {
  ...
  const getDemoInstructions = () => {
    switch (demoGuide) {
      ...
      case "Fire1.2":
        return (
          <div>
            ...
            <em>
              <strong>
                (Reminder: In this demo, objects that you need to click will be
                enveloped in a green glow.)
              </strong>
            </em>{" "}
            Click on your Avelhem hand to raise it, then click on either Fire
      ...
      case "Fire1.17":
        return (
          <div>
            ...
            <em>
              <strong>
                (Reminder: You can click on a the magnifying glass icon at the
      ...
      case "Fire1.39":
      case "Fire1.40":
        return "16. Activate Vengeful Legacy, then click on the pawn to ascend them to a Fire Scion. Flash Fire will activate; this time, the second option (recovering a Fire skill) is available. Click on it and spend any skill, then recover “Blaze Of Glory.”";
